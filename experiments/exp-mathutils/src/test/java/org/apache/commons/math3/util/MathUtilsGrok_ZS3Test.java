...
public class MathUtilsGrok_ZS3Test {
    ...
    @Test
    public void testCheckFinite_WithMultipleValuesIncludingInvalid() {
        double[] val = {1.0, Double.NaN, Double.POSITIVE_INFINITY, 2.0};
        assertThrows(NotFiniteNumberException.class, () -> MathUtils.checkFinite(val));
    }
