...
public class RangeQwen_OS3Test {
    ...
    void testElementCompareTo_withCustomComparator_elementBeforeRange_returnsMinusOne() {
        Range<String> range = Range.between("apple", "banana", String.CASE_INSENSITIVE_ORDER);
    ...
    @Test
    void testElementCompareTo_withCustomComparator_elementWithinRange_returnsZero() {
        Range<String> range = Range.between("apple", "cherry", String.CASE_INSENSITIVE_ORDER);
