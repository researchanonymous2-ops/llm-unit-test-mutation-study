...
public class RangeLlama_FS5Test {
    ...
    @Test
    void testElementCompareTo_SingletonRange_ElementInside() {
        Range<Integer> range = Range.is(5);
        assertEquals(0, range.elementCompareTo(5));
    }

    @Test
    void testElementCompareTo_SingletonRange_ElementOutside() {
        Range<Integer> range = Range.is(5);
        assertEquals(1, range.elementCompareTo(6));
    }

    @Test
    void testElementCompareTo_InvertedRange() {
