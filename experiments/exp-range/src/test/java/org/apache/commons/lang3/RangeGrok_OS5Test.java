...
public class RangeGrok_OS5Test {
   ...
   @Test
   void testElementCompareTo_SingleElementRange_ElementBefore() {
       Range<Integer> range = Range.is(5);
       assertEquals(-1, range.elementCompareTo(4));
   }

   @Test
   void testElementCompareTo_SingleElementRange_ElementEqual() {
       Range<Integer> range = Range.is(5);
       assertEquals(0, range.elementCompareTo(5));
   }

   @Test
   void testElementCompareTo_SingleElementRange_ElementAfter() {
       Range<Integer> range = Range.is(5);
       assertEquals(1, range.elementCompareTo(6));
   }
