...
public class RangeQwen_ZS4Test {
    ...
    @Test
    public void testElementCompareTo_ReverseRange_ElementBefore() {
        Range<Integer> range = Range.between(10, 5);
        assertEquals(-1, range.elementCompareTo(3));
    }

    @Test
    public void testElementCompareTo_ReverseRange_ElementAfter() {
        Range<Integer> range = Range.between(10, 5);
        assertEquals(1, range.elementCompareTo(15));
    }

    @Test
    public void testElementCompareTo_ReverseRange_ElementWithin() {
        Range<Integer> range = Range.between(10, 5);
        assertEquals(0, range.elementCompareTo(7));
    }
    ...
    @Test
    public void testElementCompareTo_CustomComparator_ElementBefore() {
    ...
    @Test
    public void testElementCompareTo_CustomComparator_ElementAfter() {
        Comparator<String> lengthComparator = Comparator.comparing(String::length);
        Range<String> range = Range.between("abc", "abcdef", lengthComparator);
    ...
    @Test
    public void testElementCompareTo_CustomComparator_ElementWithin() {
        Comparator<String> lengthComparator = Comparator.comparing(String::length);
        Range<String> range = Range.between("abc", "abcdef", lengthComparator);
