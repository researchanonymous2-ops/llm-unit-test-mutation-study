...
public class HashMapCuckooHashingLlama_FS2Test {
    ...
    void testInsertKey2HashTable_TableRehashing() {
        ...
        assertDoesNotThrow(() -> {
            ...
            map.insertKey2HashTable(3); // triggers rehashing
        });
    }

    @Test
    void testInsertKey2HashTable_InsertingIntoFullTableRehashes() {
        HashMapCuckooHashing map = new HashMapCuckooHashing(2);
        map.insertKey2HashTable(1);
        map.insertKey2HashTable(2);
        assertDoesNotThrow(() -> map.insertKey2HashTable(3)); // triggers rehashing
    }

    @Test
    void testInsertKey2HashTable_InfiniteLoopRehashes() {
        HashMapCuckooHashing map = new HashMapCuckooHashing(2);
        map.insertKey2HashTable(1);
        map.insertKey2HashTable(3);
        assertDoesNotThrow(() -> map.insertKey2HashTable(5)); // may trigger rehashing due to cuckoo hashing
    }
}
// ```