...
public class HexGrok_OS3Test {
   ...
   @Test
   void testEncodeHex_SingleByteMinValue() {
       byte[] input = {-128};
       char[] expected = {'8', '0'};
       assertArrayEquals(expected, Hex.encodeHex(input));
   }
   ...
   void testEncodeHex_MultipleBytes() {
       byte[] input = {0, 1, 15, 16, 127, -128, -1};
       char[] expected = {'0', '0', '0', '1', '0', 'f', '1', '0', '7', 'f', '8', '0', 'f', 'f'};
       assertArrayEquals(expected, Hex.encodeHex(input));
   }

   @Test
   void testEncodeHex_AllZeroes() {
       byte[] input = {0, 0, 0};
