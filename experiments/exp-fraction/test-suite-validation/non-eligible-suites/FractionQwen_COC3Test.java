...
public class FractionQwen_COC3Test {

    @Test
    public void testGetReducedFraction_DenominatorZero_ThrowsException() {
    ...
    @Test
    public void testGetReducedFraction_NumeratorZero_ReturnsZeroFraction() {
        Fraction result = Fraction.getReducedFraction(0, 5);
        assertSame(Fraction.ZERO, result);
    }

    @Test
    public void testGetReducedFraction_DenominatorMinValueAndNumeratorEven_NormalizesInputs() {
    ...
    @Test
    public void testGetReducedFraction_PositiveInputs_ReducedFraction() {
